export class QuestionLoader {
    constructor() {
        ...
        this.questionFiles = [
            '/src/data/questions-1.json',
            '/src/data/questions-2.json',
            '/src/data/questions-3.json',
            '/src/data/questions-4.json',
            '/src/data/questions-5.json',
        ];
    }
        ...
        try {
            ...
            for (const file of this.questionFiles) {
                try {
                    ...
                    console.log(`✅ Successfully loaded ${data.questions.length} questions from ${file}`);
        ...
        return [
            {
                ...
                content: "<p>Could not load questions from JSON files. Please check that the question files exist in <code>/src/data/</code> and are properly formatted.</p>",
                choices: [
                ...
                explanation: "Make sure the questions.json files are in the correct location and properly formatted.",
                link: ""
            }
        ];
    }
